#
#  Be sure to run `pod spec lint SwiftBaseKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
    Common files of swift project.
                   DESC

  spec.homepage     = "https://github.com/ColdChains/SwiftBaseKit"
  ...
  spec.source       = { :git => "https://github.com/ColdChains/SwiftBaseKit.git", :tag => "#{spec.version}" }
  ...
  # spec.source_files  = "SwiftBaseKit/*.swift"
